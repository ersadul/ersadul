...
extract >> transform_and_load
    ...
    <p><strong>Note:</strong> While submitting the dag that was created in the previous exercise, use <strong>sudo</strong> in the terminal before the command used to submit the dag.</p>
